package com.example.habittrackerapp.ui.signup
...
import com.example.habittrackerapp.databinding.ActivitySignUpBinding
    ...
    private fun setupAction() {
        binding.signupButton.setOnClickListener {
            ...
            AlertDialog.Builder(this).apply {
                setTitle("Yeah!")
                setMessage("Akun dengan $email sudah jadi nih. Yuk, login untuk masuk ke dalam aplikasi.")
